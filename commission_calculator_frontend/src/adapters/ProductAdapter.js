class ProductAdapter{  //talk to our backend API
    constructor(){  // object with our constructor
        this.baseUrl =    // instantiate with the adapter, would set base url
        "http://localhost:3000/"   //  and has ability to call get Products
    }
...
// adapter = new ProductAdapterAdapter()
// at some point we would call
